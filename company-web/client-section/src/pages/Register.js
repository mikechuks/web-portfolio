  ...
  return (
    ...
    <div className="container-fluid bg-breadcrumb">
        <div className="container text-center py-5" style={{maxWidth: '900px'}}>
            <h4 className="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Register</h4>
            ...
            <div className="row g-5"> 
                <div className="col-md-12 wow fadeInUp" data-wow-delay="0.4s">
                    <div className="bg-light p-5 rounded h-100">
                        <h4 className="text-primary mb-4">Registration Form</h4>
                        <form>
                            <div className="row g-4">
                                ...
                                <div className="col-lg-12 col-xl-6">
                                    <div className="form-floating">
                                        <input type="password" className="form-control border-0" id="phone" placeholder="Password"/>
                                        <label for="phone">Password</label>
                                    </div>
                                </div>
                                <div className="col-lg-12 col-xl-6">
                                    <div className="form-floating">
                                        <input type="password" className="form-control border-0" id="project" placeholder="Confirm Password"/>
                                ...
                                <div className="col-12">
                                    <button className="btn btn-primary w-100 py-3">Sign Up</button>
                                </div>
                            </div>
                        </form>
                    </div>
